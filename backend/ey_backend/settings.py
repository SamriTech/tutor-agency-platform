...
ALLOWED_HOSTS = ["enterological-interlineally-jolene.ngrok-free.dev","localhost","127.0.0.1","ProjectDsplay.pythonanywhere.com"]
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://ProjectDsplay.pythonanywhere.com"
]
...
STATIC_URL = 'static/'
STATIC_ROOT = Path.joinpath(BASE_DIR, os.getenv("STATIC_ROOT","staticroot"))
MEDIA_ROOT = Path.joinpath(BASE_DIR,os.getenv("MEDIA_ROOT","mediafiles"))
MEDIA_URL = "media/"
STATICFILES_DIRS = [
