...
const SessionMonitor: React.FC<SessionMonitorProps> = ({ sessions, onViewDetails }) => {
  const getStatusColor = (status: SessionStatus) => {
    switch (status) {
      case SessionStatus.Confirmed: return 'bg-green-100 text-green-800';
      case SessionStatus.Pending: return 'bg-yellow-100 text-yellow-800';
      case SessionStatus.Completed: return 'bg-blue-100 text-blue-800';
